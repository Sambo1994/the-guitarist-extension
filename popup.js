// Popup controller for The Guitarist
const state = {
  isPlaying: true,
  volume: 0.75,
  reverb: 0.6,
...
const PRESETS = {
  acoustic: { tempo: 70, density: 0.5, range: 'medium', complexity: 3, reverb: 0.6, effect: 'clean', description: 'Acoustic' },
  electric: { tempo: 80, density: 0.7, range: 'wide', complexity: 4, reverb: 0.5, effect: 'chorus', description: 'Electric' },
  classical: { tempo: 65, density: 0.4, range: 'narrow', complexity: 2, reverb: 0.8, effect: 'clean', description: 'Classical' },
  blues: { tempo: 75, density: 0.6, range: 'medium', complexity: 3, reverb: 0.4, effect: 'delay', description: 'Blues' },
  jazz: { tempo: 85, density: 0.7, range: 'wide', complexity: 5, reverb: 0.6, effect: 'chorus', description: 'Jazz' }
};
...
async function updateEffect(effect) {
  try {
    await chrome.runtime.sendMessage({ action: 'updateEffect', effect });
  } catch (error) {
